...
export function MyContributions() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-display-md font-display font-bold text-ink">My Contributions</h1>
      ...
      {residencies === null ? (
        ...
        <ul className="flex flex-col gap-3">
          {residencies.map((r) => (
            <li
              key={r.areaId}
              className="flex items-center justify-between rounded-md border border-line bg-white p-4 shadow-card"
            >
